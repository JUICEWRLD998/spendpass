...
const FEATURES = [
  {
    title: "Scoped spending",
    description:
      "Grant agents a spending cap and merchant allowlist — not your full payment credentials.",
  },
  {
    title: "AI agent powered",
    description:
      "Let AI agents search, cart, and checkout on your behalf through the Agent Auth Protocol.",
  },
  {
    title: "Full accountability",
    description:
      "Every action is tied to a cryptographic agent identity with constraints, escalation, and audit.",
  },
];
      ...
      <div className="hidden lg:flex lg:w-[460px] xl:w-[520px] shrink-0 flex-col justify-between bg-foreground text-background p-10">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-[12px] font-semibold tracking-wide opacity-60">SpendPass</span>
          </div>
        </div>
        ...
        <div className="space-y-8">
          <div className="space-y-2.5">
            ...
            <p className="text-[13px] opacity-40 leading-relaxed max-w-sm">
              Scoped spending delegation powered by the Agent Auth Protocol. Approve caps, watch the
              audit log, revoke anytime.
            </p>
          </div>
            ...
            <div className="space-y-6">
              <div className="space-y-1.5">
                ...
                <p className="text-[13px] text-foreground/40">
                  Sign in to manage your store, agents, and spending grants.
                </p>
              </div>
              ...
              <div className="lg:hidden flex items-center gap-2.5 p-3 rounded-md border border-border bg-foreground/[0.02]">
                ...
                <p className="text-[11px] text-foreground/40 leading-relaxed">
                  Delegate shopping to AI agents with spending caps through the Agent Auth Protocol.
                </p>
              </div>
